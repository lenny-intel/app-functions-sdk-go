...
func TestNewAppContext(t *testing.T) {
	...
	target := NewAppContext(expectedCorrelationId, dic)
...
func TestNewAppContextWithContentType(t *testing.T) {
	expectedContentType := clients.ContentTypeXML

	target := NewAppContextWithContentType(expectedCorrelationId, dic, expectedContentType)
...
func TestNewAppContextForTest(t *testing.T) {
	expectedContentType := ""

	target := NewAppContextForTest(expectedCorrelationId, expectedLogger)
